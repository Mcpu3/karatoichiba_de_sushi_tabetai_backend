...
def train(dataset_path: str='./training.1600000.processed.noemoticon.csv', count_vectorizer_path: str='./count_vectorizer.pickle', model_path: str='./model.pickle') -> None:
...
def __main__() -> None:
    ...
    train(args.dataset_path, args.count_vectorizer_path, args.model_path)
