...
def predict(texts: List[str], count_vectorizer_path: str='./count_vectorizer.pickle', model_path: str='./model.pickle') -> List[int]:
...
def __main__() -> None:
    ...
    predicted_pns = predict(texts, args.count_vectorizer_path, args.model_path)
